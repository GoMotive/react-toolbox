...
var Link = function Link(_ref) {
  var gomotive = _ref.gomotive,
      ...
      label = _ref.label,
      theme = _ref.theme,
      others = _objectWithoutProperties(_ref, ['gomotive', 'active', 'children', 'className', 'count', 'icon', 'label', 'theme']);
  ...
  return _react2.default.createElement(
    ...
    icon ? _react2.default.createElement(_FontIcon2.default, { gomotive: gomotive, className: theme.icon, value: icon }) : null,

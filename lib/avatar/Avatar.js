...
var factory = function factory(FontIcon) {
  var Avatar = function Avatar(_ref) {
    var gomotive = _ref.gomotive,
        ...
        theme = _ref.theme,
        title = _ref.title,
        other = _objectWithoutProperties(_ref, ['gomotive', 'children', 'className', 'cover', 'icon', 'image', 'theme', 'title']);
    ...
    return _react2.default.createElement(
      ...
      typeof icon === 'string' ? _react2.default.createElement(FontIcon, { gomotive: gomotive, className: theme.letter, value: icon }) : icon,

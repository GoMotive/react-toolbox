...
var factory = function factory(Dialog) {
  var TimePickerDialog = function (_Component) {
    ...
    function TimePickerDialog(props, context) {
      _classCallCheck(this, TimePickerDialog);

      var _this = _possibleConstructorReturn(this, (TimePickerDialog.__proto__ || Object.getPrototypeOf(TimePickerDialog)).call(this, props, context));
      ...
      _this.setClockRefs = function (ref) {
        _this.clockNode = ref;
      };
      ...
      _this.actions = [{ label: _this.props.cancelLabel, className: _this.props.theme.button, onClick: _this.props.onDismiss }, { label: _this.props.okLabel, className: _this.props.theme.button, name: _this.props.name, onClick: _this.handleSelect }];

      _this.setClockRefs = _this.setClockRefs.bind(_this);
      return _this;
    }

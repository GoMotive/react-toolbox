    ...
    _createClass(Button, [{
      ...
      value: function render() {
        ...
        var _props = this.props,
            ...
            others = _objectWithoutProperties(_props, ['gomotive', 'accent', 'children', 'className', 'flat', 'floating', 'href', 'icon', 'inverse', 'label', 'mini', 'neutral', 'primary', 'theme', 'type', 'raised']);
        ...
        return _react2.default.createElement(element, props, icon ? _react2.default.createElement(FontIcon, { gomotive: gomotive, className: theme.icon, value: icon }) : null, label, children);
      }
    }]);

    ...
    _createClass(IconButton, [{
      ...
      value: function render() {
        ...
        var _props = this.props,
            ...
            theme = _props.theme,
            type = _props.type,
            others = _objectWithoutProperties(_props, ['gomotive', 'accent', 'children', 'className', 'href', 'icon', 'inverse', 'neutral', 'primary', 'theme', 'type']);
        ...
        return _react2.default.createElement(element, props, icon ? typeof icon === 'string' ? _react2.default.createElement(FontIcon, { gomotive: gomotive, className: theme.icon, value: icon }) : icon : null, children);
      }
    }]);

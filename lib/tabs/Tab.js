  ...
  _createClass(Tab, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          icon = _props.icon,
          theme = _props.theme,
          other = _objectWithoutProperties(_props, ['gomotive', 'onActive', 'active', 'activeClassName', 'className', 'disabled', 'hidden', 'label', 'icon', 'theme']);
      ...
      return _react2.default.createElement(
        ...
        icon && _react2.default.createElement(_font_icon.FontIcon, { gomotive: gomotive, className: theme.icon, value: icon }),
        label
      );
    }
  }]);
